...
const MultiFileUploadReport: FC<Props> = ({ uploadType, resetSignal }) => {
  const maxFiles = 5;
  ...
  return (
    ...
    <div>
      ...
      <p className="error-txt">
        {t('file.report.uploadLimitMessage')}
      </p>
      ...
      <CommonAlertDialog
        ...
        title={t('file.report.exception.max.title')}
        description={errorMessage}
        confirmText={t('file.report.confirm')}
        onConfirm={onIsFileUploadFailConfirm}
      />
      <CommonAlertDialog
        type="normal"
        isOpen={isMaxFile}
        title={t('file.report.exception.maxSize.title')}
        description={errorMessage}
        confirmText={t('file.report.confirm')}
      ...
      <CommonAlertDialog
        ...
        title={t('file.report.success.title')}
        description={t('file.report.success.desc', { fileName: successFileName })}
        confirmText={t('file.report.confirm')}
      ...
      <CommonAlertDialog
        ...
        title={t('file.report.error.title')}
        description={errorMessage}
        confirmText={t('file.report.confirm')}
...
export default MultiFileUploadReport;