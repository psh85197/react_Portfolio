...
const NavigationMenuContext = React.createContext<{
  ...
  setTriggerLeft: (left: number | null) => void;
}>({
  triggerLeft: null,
  setTriggerLeft: () => {}
});
...
>(({ className, children, ...props }, ref) => {
  const [triggerLeft, setTriggerLeft] = React.useState<number | null>(null);
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      {...props}
    >
      <NavigationMenuContext.Provider value={{ triggerLeft, setTriggerLeft }}>
        {children}
...
>(({ className, children, ...props }, ref) => {
  const { setTriggerLeft } = React.useContext(NavigationMenuContext);
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      onMouseOver={(e) => {
        const absoluteLeft = e.currentTarget.offsetLeft;
        setTriggerLeft(absoluteLeft);
      }}
      {...props}
    >
      {children}{" "}
...
>(({ className, ...props }, ref) => {
  const { triggerLeft } = React.useContext(NavigationMenuContext);
