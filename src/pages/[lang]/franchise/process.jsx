                      ...
                      <div className="step-cont">
                        <ul className="desc-list">
                          ...
                          <li className="basic font-sm">
                            <Link to={`/${lang}/pub/pages/contact/signup-inquiry`} target="_blank">가입신청 및 문의 바로가기</Link>
                          </li>
                        </ul>
                      </div>
                    </li>
                    ...
                    <li>
                      ...
                      <div className="step-cont">
                        <ul className="desc-list">
                          ...
                          <li className="basic font-sm"><a href="https://www.medicalkorea.or.kr/korp">보건산업진흥원 바로가기</a></li>
                        </ul>
                      </div>
                    </li>
                    <li>
                  ...
                  <ul className="step-wrap">
                    ...
                    <li>
                      <div className="step-tit">
                        <div>
                          <p className="num">STEP 2</p>
                          <p className="tit">한국 호텔업 협회 신청</p>
                        </div>
                      </div>
                      <div className="step-cont">
                        <ul className="desc-list">
                          <li>
                          {/* 20250526 : 퍼블 문구 수정 : S */}
                          한국호텔업협회 또는 한국휴양콘도미니엄 경영협회에 신청
                          {/* 20250526 : 퍼블 문구 수정 : E */}
                          </li>
                          <li className="basic font-sm"><a href="http://www.hotelskorea.or.kr/plaza/index_1.php?b_id=001">한국 호텔업 협회 바로가기</a>
                          <a href="http://www.condo.or.kr/index.asp">한국휴양콘도미니엄 경영협회 바로가기</a></li>
                        </ul>
                      </div>
                    </li>
                    <li>
