...
import features04 from "@/assets/images/contents//tax-refund/features_04.png";
              ...
              <div className="info-bx no-scroll">
                <ul className="info-list">
                  <li className="info-item">
                    ...
                    {renderDescription(t("features.feature4.description"))}
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section>
        <div className="btn-wrap">
          <div className="btn-inner line-type">
            <Button className="btn btn-primary">{t("features.whyCubeRefundButton")}</Button>
          </div>
        </div>
      </section>
    </div>
